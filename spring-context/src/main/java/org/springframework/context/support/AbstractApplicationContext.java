	...
	public void refresh() throws BeansException, IllegalStateException {
		...
		try {
			...
			try {
				...
				// 工厂增强：执行所有的BeanFactory后置增强器；利用BeanFactory后置增强器对工厂进行修改或者增强,配置类会在这里增强 Invoke factory processors registered as beans in the context.
